...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    "protocolo.common.context_processors.distribuitor",
)
...
AUTHENTICATION_BACKENDS = (
    'protocolo.accounts.auth.MongoEngineBackend',
)

SESSION_ENGINE = 'mongoengine.django.sessions'

ROOT_URLCONF = 'protocolo.urls'
WSGI_APPLICATION = 'protocolo.wsgi.application'
