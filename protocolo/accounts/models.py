...
from protocolo.unidades.models import Unidade
...
class UnidadeProfile(User):
    """
    Usuário que perence a uma unidade e possui autenticação
    """
    unidade = ReferenceField(Unidade, 
...
user_logged_in.connect(user_logged_in_cb,
                       dispatch_uid = "protocolo.accounts.models.user_logged_in_cb")

user_logged_out.connect(user_logged_out_cb,
                       dispatch_uid = "protocolo.accounts.models.user_logged_out_cb")
