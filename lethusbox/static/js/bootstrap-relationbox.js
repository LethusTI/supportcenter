/* =============================================================
 * bootstrap-relationbox.js v1.0.0
 * =============================================================
 * Copyright 2012 Wilson Pinto Júnior
 *
...
!function( $ ) {
    ...
    "use strict"
    var RelationBox = function (element, options) {
        this.options = $.extend({}, $.fn.relationbox.defaults, options)
    ...
    RelationBox.prototype = $.extend({}, $.fn.typeahead.Constructor.prototype, {

        constructor: RelationBox
        ...
        , setup: function (element) {
            ...
            this.$element.appendTo(combobox.find('div.input-container'));
    ...
    /* RELATIONBOX PLUGIN DEFINITION
     * =========================== */

    $.fn.relationbox = function ( option ) {
        return this.each(function () {
            var $this = $(this)
            , data
            , options = typeof option == 'object' && option
            $this.data('relationbox', (data = new RelationBox(this, options)))
            if (typeof option == 'string') data[option]()
        })
            }

    $.fn.relationbox.defaults = {
        template: '<div class="combobox-container"><div class="input-container"></div><span class="add-on btn dropdown-toggle" data-dropdown="dropdown"><span class="caret"/><span class="combobox-clear"><i class="icon-remove"/></span></span></div>'
        , menu: '<ul class="typeahead typeahead-long dropdown-menu"></ul>'
        , item: '<li><a href="#"></a></li>'
        , placeholder: null
    }

    $.fn.relationbox.Constructor = RelationBox
